...
$string['certify:configurecustomfields'] = 'Configure certification custom fields';
...
$string['source_ecommerce_allownew_desc'] = 'Allow adding new _e-commerce auto allocation_ sources to certifications';;
