...
$string['columnusedalready'] = 'Columns used already';
...
$string['source_manual_timestartcolumn'] = 'Time window start';
$string['source_manual_timeduecolumn'] = 'Time window due';
$string['source_manual_timeendcolumn'] = 'Time window end';
