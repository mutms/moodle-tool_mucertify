...
final class assignment_periods extends system_report {
    ...
    protected function initialise(): void {
        global $DB;
        $this->assignment = $DB->get_record('tool_mucertify_assignment', ['id' => $this->get_parameters()['assignmentid']], '*', MUST_EXIST);
        $this->certification = $DB->get_record('tool_mucertify_certification', ['id' => $this->assignment->certificationid], '*', MUST_EXIST);
