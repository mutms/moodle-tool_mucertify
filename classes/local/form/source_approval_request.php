...
/**
 * Request certification assignment.
 *
...
final class source_approval_request extends \tool_mulib\local\dialog_form {
    ...
    protected function definition() {
        ...
        $confirmation = markdown_to_html(get_string('source_approval_confirm', 'tool_mucertify'));
        ...
        $this->add_action_buttons(true, get_string('source_approval_makerequest', 'tool_mucertify'));
    }
